...
from models import SIAMESE,SIAMESE2
...
def main(options):
    ...
    for epoch_i in range(options.epochs):
        ...
        logging.info("Average validation loss value per instance is {0} at the end of epoch {1}".format(dev_avg_loss.data[0], epoch_i))
